...
public class HelloJDBC {
	...
	public static final String PASSWORD = "ji3cp3gj94";
	...
	public static void main(String[] args) {
		...
		Scanner sc = new Scanner(System.in);System.out.println("要新增的編號");
		int deptno = sc.nextInt();System.out.println("要新增的名稱");
		String dname = sc.next();System.out.println("要新增的所在地");
		String loc = sc.next();
